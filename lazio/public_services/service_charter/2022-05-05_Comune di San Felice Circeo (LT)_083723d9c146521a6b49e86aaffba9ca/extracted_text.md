...
In particolare, la presente Carta dei Servizi e predisposta in riferimento a:
...
Il valore di pressione presso i punti di fornitura risente dei limiti della disponibilità e delle possibilità della rete di distribuzione, nonché dei consumi che possono variare in base alle fasce orarie ed alle stagioni.
...
# 4.8 PRONTO INTERVENTO (rif. art.33 RQSII Del. 655/2015 Arera)
...
# 5.2 INSTALLAZIONE, MANUTENZIONE E VERIFICA DEI MISURATORI (rif. art. 6 TIMSII Del. 218/2016 Arera)
...
# 5.5 INFORMAZIONI AGLI UTENTI E AVVISI DI LETTURA (rif. art. 7.4 TIMSII Del. 218/2016 Arera, art. 26 TICSI Del. 665/2017)
...
# 6.2 TEMPO PER L'EMISSIONE DELLA FATTURA (rif. art. 36 RQSII Del. 655/2015 Arera)
...
# 6.3 PERIODO DI RIFERIMENTO DELLA FATTURA (rif. art. 37 RQSII Del. 655/2015 Arera)
...
# 6.4 PERIODICITÀ DI FATTURAZIONE (rif. art.38 RQSII Del. 655/2015 Arera e art.10 TIMSII Del. 218/2016 Arera)
...
# 6.5 FATTURA DI CHIUSURA DEL RAPPORTO CONTRATTUALE (rif. art. 39 RQSII Del. 655/2015 Arera)
...
# 6.6 TERMINI PER I PAGAMENTI (rif. art. 40 RQSII Del. 655/2015 Arera)
Le somme dovute dagli utenti dovranno essere pagate entro la data di scadenza indicata sulla bolletta.
...
# 6.7 MODALITÀ E STRUMENTI DI PAGAMENTO (rif. art. 41 RQSII Del. 655/2015 Arera)
...
# 6.8 MODALITÀ PER LA RATEIZZAZIONE DEI PAGAMENTI (rif. art. 42 RQSII Del. 655/2015 Arera)
...
# 6.9 RETTIFICA DI FATTURAZIONE (rif. art. 43 e 44 RQSII Del. 655/2015 Arera)
...
# ART. 7 - MOROSITÀ (rif. DPCM 29 aprile 1999, DPCM 29 agosto 2016 e REMSI Del. 311/2019 Arera)
...
# 7.1 SOLLECITO BONARIO DI PAGAMENTO (rif. art. 3 REMSI Del. 311/2019 Arera)
...
# 7.2 COSTITUZIONE IN MORA (rif. art. 4 REMSI Del. 311/2019 Arera)
...
# 7.3 CASI DI ESCLUSIONE DELLA COSTITUZIONE IN MORA (rif. art. 4 REMSI Del. 311/2019 Arera)
...
# 7.4 TERMINI PER IL PAGAMENTO (rif. art. 4 REMSI Del. 311/2019 Arera)
...
# 7.5 ADDEBITO DEGLI INTERESSI DI MORA E DELLE SPESE AGGIUNTIVE (rif. art. 4 REMSI Del. 311/2019 Arera)
...
# 7.6 RATEIZZAZIONE DEGLI IMPORTI OGGETTO DI COSTITUZIONE IN MORA (rif. art. 5 REMSI Del. 311/2019 Arera)
...
# 7.7 LIMITAZIONE DELLA FORNITURA DELL'UTENTE MOROSO NON DISALIMENTABILE (rif.art.2 e art.8 REMSI Del. 311/2019 Arera)
...
- il Gestore abbia provveduto a costituire in mora l'utente nei tempi e con le modalità di cui al precedente art. 7.2;
- il Gestore vanti un credito nei confronti dell'utente anche successivamente all'escussione del deposito cauzionale;
- siano decorsi i termini di cui al precedente art. 7.4, senza che l'utente abbia estinto il debito dandone comunicazione al Gestore o abbia inoltrato richiesta di rateizzazione di cui al precedente art. 7.6.
...
# 7.8 LIMITAZIONE, SOSPENSIONE, DISATTIVAZIONE DELLA FORNITURA DELL'UTENTE MOROSO DOMESTICO RESIDENTE, DIVERSO DA QUELLO NON DISALIMENTABILE (rif. art.7 REMSI Del. 311/2019 Arera)
...
# 7.9 SOSPENSIONE, DISATTIVAZIONE DELLA FORNITURA DELL'UTENTE MOROSO DISALIMENTABILE (rif. art.7 REMSI Del. 311/2019 Arera)
...
- il Gestore ha provveduto a costituire in mora l'utente moroso nei tempi e con le modalità di cui al precedente art. 7.2;
...
- siano decorsi i termini di cui al precedente art. 7.4, senza che l'utente abbia estinto il debito dandone comunicazione al Gestore con le modalità di cui all'art. 3.5 della presente Carta o abbia inoltrato richiesta di rateizzazione ai sensi del precedente art. 7.6;
...
# 7.10 ESCUSSIONE DEL DEPOSITO CAUZIONALE PER MOROSITÀ (rif. art.4 Del. 311/2019 Arera)
...
# 8.1 CLASSIFICAZIONE DELLE RICHIESTE SCRITTE (rif. art. 45 RQSII Del. 655/2015 Arera)
...
# 8.2 PROCEDURA DI PRESENTAZIONE DEI RECLAMI SCRITTI (rif. art. 49 RQSII Del. 655/2015 Arera)
...
# 8.3 RISPOSTA A RECLAMI SCRITTI (rif. art. 46 e 50 RQSII Del. 655/2015 Arera)
...
Nella stessa risposta il Gestore fornirà all'utente le informazioni per risolvere la controversia, indicando le modalità di attivazione del Servio Conciliazione dell'Autorità nonché di altri organismi.

# 8.4 RECLAMI SCRITTI MULTIPLI (rif. art. 51 RQSII Del. 655/2015 Arera)
...
# 8.5 RISPOSTA A RICHIESTA SCRITTA DI INFORMAZIONI (rif. artt. 47 e 50 RQSII Del. 655/2015 Arera)
...
# 8.6 RISPOSTA A RICHIESTA SCRITTA DI RETTIFICA DI FATTURAZIONE (rif. artt. 48 e 50 RQSII Del. 655/2015 Arera)
...
# 9.1 INDENNIZZI PER MANCATO RISPETTO DEGLI STANDARD SPECIFICI DI QUALITÀ TECNICA E CONTRATTUALE (rif. art. 72 RQSII Del. 655/2015 Arera, art.5 RQTI Del. 917/2017 Arera)
...
# 9.2 INDENNIZZI PER ERRATA ESECUZIONE DEGLI INTERVENTI DI LIMITAZIONE, SOSPENSIONE, DISATTIVAZIONE DELLA FORNITURA PER MOROSITÀ (rif. art. 10 REMSI Del. 311/2019 Arera)
...
- in tutti i casi in cui in relazione ad un utente domestico residente il Gestore abbia proceduto con la disattivazione della fornitura per morosità, fatto salvo quanto previsto al precedente art. 7.8;
...
- qualora la fornitura sia stata limitata, sospesa o disattivata per morosità nonostante l'utente finale abbia provveduto a comunicare l'avvenuto pagamento nei tempi e con le modalità di cui all'art. 3.5 della presente Carta.
...
- l'utente finale abbia inoltrato richiesta di rateizzazione nei tempi e con le modalità di cui al precedente art. 7.6;
- non sia stato inviato il sollecito bonario di pagamento di cui all'art. 7.1 della presente Carta.

# 9.3 INDENNIZZO CRESCENTE (rif. art. 72 RQSII Del. 655/2015 Arera e art. 5.2 RQTI Del. 917/2017 Arera)
L'indennizzo automatico base di cui al comma 9.1 è crescente in relazione al ritardo nell'esecuzione della prestazione come di seguito indicato:
...
# 9.4 ESCLUSIONE DEL DIRITTO ALL'INDENNIZZO (rif. art. 73 RQSII Del. 655/2015 Arera e art.5 comma 5.5 RQTI Del. 917/2017 Arera)
Il Gestore non è tenuto a corrispondere l'indennizzo automatico:
- qualora il mancato rispetto degli standard specifici di qualità sia riconducibile ad una delle seguenti cause:
    - cause di forza maggiore, intese come atti di autorità pubblica, eventi naturali eccezionali per i quali sia stato dichiarato lo stato di calamità dall'autorità competente, scioperi indetti senza il preavviso previsto dalla legge, mancato ottenimento di atti autorizzativi;
...
- nel caso in cui all'utente diretto sia già stato corrisposto nell'anno solare un indennizzo per mancato rispetto del medesimo livello specifico;
...
- in caso di reclami o altra comunicazione per i quali non è possibile identificare l'utente perché non contengono le informazioni minime previste dall'Articolo 8, comma 8.2 della presente Carta.

# 9.5 SOSPENSIONE DELL'EROGAZIONE DELL'INDENNIZZO (rif. art. 73 RQSII Del. 655/2015 Arera e art.5 comma 5.6 RQTI Del. 917/2017 Arera)
Il Gestore può sospendere l'erogazione dell'indennizzo automatico nei seguenti casi:
- nel caso in cui l'utente risulti moroso, può sospendere l'erogazione fino al pagamento delle somme dovute, ai sensi dell'art. 73 comma 73.2 dell'Allegato A RQSII alla Deliberazione 655/2015/R/IDR;
...
# 9.6 MODALITÀ DI CORRESPONSIONE DELL'INDENNIZZO (rif. art.74 RQSII Del. 655/2015 Arera, art.5 comma 4 RQTI Del. 917/2017 Arera, art. 10 comma 4 REMSI Del. 311/2019 Arera)
...
# 9.7 TEMPO DI CORRESPONSIONE DELL'INDENNIZZO (rif. art. 74 RQSII Del. 655/2015 Arera)
Il Gestore provvederà a corrispondere all'utente l'indennizzo automatico, ove dovuto, entro 180 giorni solari dalla richiesta della prestazione oggetto di standard specifico e, nel caso in cui l'utente risulti moroso, dal giorno in cui effettua il pagamento delle somme dovute.
...
# 10.2 GESTIONE DEI RECLAMI (rif. DPCM 29 aprile 1999)
...
# 10.4 CONTROLLI ESTERNI (rif. DPCM 29 aprile 1999)
...
# 10.5 VALUTAZIONE DEL GRADO DI SODDISFAZIONE DELL'UTENTE (rif. DPCM 29 aprile 1999)
...
# 10.8 VALIDITÀ DELLA CARTA DEI SERVIZI (rif. DPCM 29 aprile 1999)
La presente Carta dei Servizi è stata approvata dalla Conferenza dei Sindaci e dei Presidenti dell'A.T.O. n. 4 – Lazio Meridionale Latina con Deliberazione n° 10 del 05/05/2021.
